   ...
   //Moving onto Req. 1
          ...
          for (var word in e.data.hardWords) {
            if (word == selected) {
              ...
              if (hCount == 1) {
                ...
                console.log('setting what changed as selected hard word')
              }
            }
    ...
    base.createItem({
      ...
      updateFrom: function(publisher) {
        var pub = publisher.getDataEtc();
        var here = this.getDataEtc();
        console.log('in ins tool: ' + pub.whatChanged)
        console.log('in ins tool: here.hardWord: ' + here.hardWord + ', pub.selectedWord: ' + pub.selectedWord)
        var whatChanged = ''
    ...
    base.createItem({
      ...
      updateFrom: function(publisher) {
        ...
        if (pub.whatChanged == "extra sentence for existing hard word") {
          ...
          console.log('displayed one more')
        }
        if (pub.whatChanged == "selected type and therefore probably selected word" || 
          ...
          console.log('removed coz changed: ' + pub.whatChanged)
        }
        if (pub.hardWord && (pub.whatChanged == "selected type and therefore probably selected word" || 
          ...
          domIndex = 1;
          console.log('displayed all coz changed: ' + pub.whatChanged)
